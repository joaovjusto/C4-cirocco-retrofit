...
void setup() {
  ...
  canAmbiance.data[1] = 0x4E;  // Empty data
...
void loop() {
  ...
  if (CAN0.readMessage(&canMsgRcv) == MCP2515::ERROR_OK) {
    ...
    //   canMsgSnd = canMsgRcv;  //copy frame
    //   if (vp2forcerear) {
    //     canMsgSnd.data[7] = bitWrite(canMsgSnd.data[7], 7, 1);
    //     Serial.println("vp2 rear forced writed");
    //   }                                                                              //we need to change reverse gear value
